...
def export_image(qemu_nbd, filename, local_image, params):
    ...
    :param params: local image specified params, params may contain:
        ...
        nbd_export_bitmap: bitmap names seperated by space, e.g. 'bm1 bm2'
    ...
    bitmap_setting = ''
    for bm in params.objects('nbd_export_bitmap'):
        bitmap_setting += ' -B %s' % bm
    if bitmap_setting:
        cmd_dict['bitmap'] = bitmap_setting.strip()
